	...
	acf_add_local_field_group( [
		...
		'fields'   => [
			...
			[
				...
				'return_format' => 'array',
				'preview_size'  => 'medium',
				'instructions'  => 'Logo overlaid on the background image.',
			],
			[
				'key'   => 'field_sister_site_bg_color',
				'label' => 'Sister Site Background Color',
				'name'  => 'sister_site_bg_color',
				'type'  => 'color_picker',
				'default_value' => '#111111',
				'instructions'  => 'Background color for the left content area.',
			],
			[
				'key'           => 'field_sister_site_image',
				'label'         => 'Sister Site Background Image',
				'name'          => 'sister_site_image',
				'type'          => 'image',
				'return_format' => 'array',
				'preview_size'  => 'medium',
				'instructions'  => 'Background image for the right side of the banner. Recommended: 800x500px minimum.',
			],
			[
